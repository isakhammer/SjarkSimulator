...
LOG_ENABLED = os.environ.get("SJ_TEST_LOG", "1").strip().lower() not in (
    "0",
    "false",
    "no",
)
DEFAULT_LOG_DIR = os.path.join(os.getcwd(), "build", "sj_launch", "test_logs")
LOG_DIR = os.environ.get("SJ_TEST_LOG_DIR", DEFAULT_LOG_DIR)
