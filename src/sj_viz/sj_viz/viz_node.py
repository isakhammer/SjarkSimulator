...
from sj_utils.bspline import eval_bspline, samples_from_density
from sj_msg.msg import BsplinePath, ControllerState
from geometry_msgs.msg import Pose, PoseStamped, Point
from visualization_msgs.msg import Marker, MarkerArray

import numpy as np

from sj_msg.msg import BoatState
...
class BoatVisualizer(Node):
    def __init__(self):
        ...
        self.declare_parameter("urdf_path", "/root/code/src/sj_launch/urdf/boat.urdf")
