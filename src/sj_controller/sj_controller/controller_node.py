...
from sj_controller.los import path_yaw_from_tangent, wrap_to_pi
from sj_utils.bspline import (
    BSplinePath,
    ProjectionTracker,
    samples_from_density,
)
from sj_utils.ros_params import load_ros_params
...
class ControllerNode(Node):
    def __init__(self):
        ...
        default_config = os.path.join(
            get_package_share_directory("sj_launch"),
            "config",
