...
craft simulation. It is not implemented in the current codebase, but it provides
a consistent extension path from the 3~DOF model.
...
\[
  ...
  \Big),
\]
and integrate with RK4. Normalize $\mathbf{q}_{WB}$ after each integration step.
